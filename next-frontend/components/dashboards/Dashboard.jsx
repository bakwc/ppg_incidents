...
export default function Dashboard() {
  ...
  const currentCategory = menuStructure.find(cat => pathname === cat.path)?.id || 'causes-analysis';
  const currentCategoryIndex = menuStructure.findIndex(cat => pathname === cat.path);
        ...
        <div className="hidden lg:block lg:fixed lg:left-0 lg:top-16 lg:h-[calc(100vh-4rem)] lg:w-64 xl:w-72 bg-slate-900 border-r border-slate-800 p-4 xl:p-6 overflow-y-auto">
          ...
          <nav className="space-y-1">
            {menuStructure.map(category => {
              const isCurrentCategory = pathname === category.path;
              return (
                  ...
                  <div className="mt-1.5 ml-3 pl-3 border-l-2 border-slate-700 space-y-1">
                    {category.sections.map(section => (
                      <button
                        key={section.id}
                        onClick={() => {
                          router.push(`${category.path}#${section.id}`);
                        }}
        ...
        <div className="lg:ml-64 xl:ml-72 flex-1">
          ...
          <div className="p-4 md:p-6 xl:p-8">
            <div className="max-w-4xl mx-auto">
              ...
              {pathname === '/dashboard/causes-analysis' && (
              ...
              {pathname === '/dashboard/flight-conditions' && (
              ...
              {pathname === '/dashboard/safety-equipment' && (
              ...
              {pathname === '/dashboard/trends-distribution' && (
