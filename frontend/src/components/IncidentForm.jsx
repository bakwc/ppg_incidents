...
import { fetchIncident, createIncident, updateIncident } from '../api';
  ...
  return (
    <div>
      ...
      <input
        ...
        className="w-full px-4 py-2.5 bg-slate-900/50 border border-slate-600/50 rounded-xl text-white placeholder-slate-500 focus:outline-none focus:border-orange-500/50 focus:ring-1 focus:ring-orange-500/25 transition-all"
      />
    </div>
  );
}
  ...
  return (
    <div>
      ...
      <textarea
        ...
        rows={rows}
        placeholder={placeholder}
        className="w-full px-4 py-2.5 bg-slate-900/50 border border-slate-600/50 rounded-xl text-white placeholder-slate-500 focus:outline-none focus:border-orange-500/50 focus:ring-1 focus:ring-orange-500/25 transition-all resize-none"
      />
    </div>
  );
}
  ...
  return (
    <div>
      ...
      <select
        ...
        value={value || ''}
        onChange={onChange}
        className="w-full px-4 py-2.5 bg-slate-900/50 border border-slate-600/50 rounded-xl text-white focus:outline-none focus:border-orange-500/50 focus:ring-1 focus:ring-orange-500/25 transition-all appearance-none cursor-pointer"
      >
        {options.map(opt => (
  ...
  return (
    <label className="flex items-center gap-3 cursor-pointer group">
      <div className="relative">
        ...
        />
        <div className="w-5 h-5 bg-slate-900/50 border border-slate-600/50 rounded-md peer-checked:bg-orange-500 peer-checked:border-orange-500 transition-all" />
        <svg
